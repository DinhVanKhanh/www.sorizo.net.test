                    ...
                    <table width="650" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto; text-align:left;">
                        <tr>
                            <td nowrap width="170" align="left" style="padding-left:2px;"><img
                                    src="images/pkg_nbk11_ja_ac.gif"></td>
                            <td width="480">
                                <table width="480" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            本プログラムをダウンロードすることで、「接続キット 愛知県版」のサービスをご利用いただくことができるようになります。
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <div style="font:normal 14px/20px Meiryo,メイリオ,sans-serif;"><a
                                                        href="../core/download.php?dir=<?= $curDir ?>" target="_blank"><img
                                                            src="/images/btn_down_g.gif"
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <div style="font:bold 14px/20px Meiryo,メイリオ,sans-serif;"><a
                                                        href="../core/download.php?dir=<?= $curDir ?>&option=manual" target="_blank"><img
                                                            src="/images/btn_down_g.gif"
                                                            onMouseover="this.src='/images/btn_down_r.gif'"
                                                            onMouseout="this.src='/images/btn_down_g.gif'" border="0"
                                                            alt="プログラムファイルダウンロード"></a>
