            ...
            <tr>
                <td width="650">
                    <table width="650" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;">
                        <tr>
                            <td nowrap width="150" height="150px" align="center"
                                style="padding:2px; background:url('images/pkg_nbk11_jakit.gif') no-repeat; color:#fff; font-weight:bold; font-style:Meiryo; font-size:24px; text-shadow:1px 2px 3px #000; ">
                                接続キット<br>長野県版</td>
                                ...
                                <table width="480" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            本プログラムをダウンロードすることで、「接続キット 長野県版」のサービスをご利用いただくことができるようになります。
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <table width="650" class="list_g1">
                                        ...
                                        <tr>
                                            <td style="padding:5px; background-color:#fff; border:1px #bbb solid;">
                                                <div style="font:bold 14px/20px Meiryo,メイリオ,sans-serif;">「接続キット
                                                    長野県版」変換プログラム
                                            </td>
                                            <td style="padding:5px; background-color:#fff; border:1px #bbb solid;">
