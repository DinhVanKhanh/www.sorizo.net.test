<?php
    ...
    switch ($rq_file){
        case "prg1":
            ...
            $v_filename = "download_files_ot/BK11spKit.exe";
        break;
        case "mn1":
            $v_version = "11_00_00";   
            $v_filetype = "マニュアル";
	...
	$csv_body = $myDate . "," . $myTime . "," . $v_version . ",接続キット-JA大分県版," . $v_filetype . "," . $ip . "," . $serial_no . ",";

	$FileName = $LogFileDirectory . "af_download\download_log_softdown_ja_ot.txt";
