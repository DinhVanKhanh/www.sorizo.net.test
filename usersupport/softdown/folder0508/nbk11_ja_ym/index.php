<?php
    ...
    if ($WEBSERVER_FLG == 0){ // 本サーバーの場合
        ...
        if ($_COOKIE["LoginProduct"]["serialno"] != "1015118000009287"){
            ...
            if ($_COOKIE["LoginProduct"]["userpref"] == "山形県"){
...
<table width="650" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;">
  <tr>
    <td nowrap width="150" height="150px" align="center" style="padding:2px; background:url('images/pkg_nbk11_jakit.gif') no-repeat; color:#fff; font-weight:bold; font-style:Meiryo; font-size:24px; text-shadow:1px 2px 3px #000; ">接続キット<br>山形県版</td>
    <td nowrap width="20" align="left" style="padding-left:2px;"></td>
    <td width="480">
<table width="480" border="0" cellspacing="0" cellpadding="0">
  <tr><td>
<div style="color:#404040; font:24px/130% Meiryo,メイリオ,'ＭＳ Ｐゴシック',osaka,sans-serif; font-weight:bold;">「接続キット 山形県版」
</div>
<div style="color:#404040; font:20px/130% Meiryo,メイリオ,'ＭＳ Ｐゴシック',osaka,sans-serif; font-weight:bold;">　変換プログラム（農業簿記11.01<!--以降-->用）</div>
  </td></tr>
  <tr><td style="padding:5px 0 0 2px; font:normal 90%/140% Meiryo,メイリオ,'ＭＳ Ｐゴシック',sans-serif; border-top:1px #808080 dotted;">本プログラムをダウンロードすることで、「接続キット 山形県版」のサービスをご利用いただくことができるようになります。
<!--
...
-->
  ...
  <tr>
    <td colspan="3" style="padding:40px 0 10px 0px;">
      <div>
...
-->
        ...
        <tr>
          <td style="padding:5px; background-color:#fff; border:1px #bbb solid;"><div style="font:bold 14px/20px Meiryo,メイリオ,sans-serif;">「接続キット 山形県版」変換プログラム</td>
        ...
        <tr>
          <td style="padding:5px; background-color:#fff; border:1px #bbb solid;"><div style="font:bold 14px/20px Meiryo,メイリオ,sans-serif;">「接続キット 山形県版」マニュアル</td>
