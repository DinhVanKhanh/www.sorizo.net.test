...
<div style="color:#404040; font:20px/130% Meiryo,メイリオ,'ＭＳ Ｐゴシック',osaka,sans-serif; font-weight:bold;">Ver.11.00専用 サービスパック</div>
    </td>
  </tr>
...
<th nowrap class="list_g2">解説</th>
        ...
        <tr>
          <td nowrap class="list_g1"><b>「農業簿記11 JAバージョン」<br>Ver.11.00 専用サービスパック</b></td>
          <td class="list_g1w">いくつかの機能を改善した最新版です。<b><u>Version 11.00.xx<!-- ～ 11.00.0x-->がインストールされているお客様のみ導入可能</u></b>です。--></td>
          <td class="list_g1w">プログラム[.exe]<br>（5.53MB）</td>
          <td class="list_g1w" align="center"><a href="download.php?f=prg1" target="_blank"><img src="../images/btn_download_r_a.gif" onMouseover="this.src='../images/btn_download_r_b.gif'" onMouseout="this.src='../images/btn_download_r_a.gif'" border="0" alt="プログラムファイルダウンロード"></a></td>
        </tr>
        <tr>
          ...
          <td class="list_g1w" align="center"><a href="download.php?f=mn1" target="_blank"><img src="../images/btn_download_y_a.gif" onMouseover="this.src='../images/btn_download_y_b.gif'" onMouseout="this.src='../images/btn_download_y_a.gif'" border="0" alt="PDFマニュアルダウンロード"></a></td>
        </tr>
        <tr>
...
<u>Ver.11.01</u> をお使いの方は [ <a href="../ja11_1101/"><b>こちら</b></a> ]<br>
</div>
</div>
