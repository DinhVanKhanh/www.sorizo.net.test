<?php
    ...
    if (isset($_REQUEST['option'])) {
        if ($_REQUEST['option'] == 'manual') {
            execDownload("\downloadmanual_log_2017.txt", ",農業簿記10_平成29年 年末レベルアップ版（Ver10.01.00）,マニュアル,Ver171208", "download_files/bk10_01_00_lu_setup_m1.pdf", true);
        }
        execDownload("\download_log_2017.txt", ",農業簿記10_平成29年 年末レベルアップ版（Ver10.01.00）,プログラム,Ver171222,", "http://sorimachi-download.s3-ap-northeast-1.amazonaws.com/prg/lvup/nbk10_01_00/BK10LU_H29SETUP.exe", true);
    }
...
<html lang="ja">
    <head>
        ...
        <meta name="description" content="農業簿記10 平成29年 年末レベルアップ版 ダウンロード" />
        <title>農業簿記10&nbsp;平成29年 年末レベルアップ版&nbsp;ダウンロード｜そり蔵ネット</title>
    ...
    <?php require_once '../../../lib/header_general.php'; ?>
        <article id="home" class="clearfix">
            <nav class="clearfix">
                <h1><a href="/index.php" onfocus="this.blur()">農業簿記10&nbsp;平成29年 年末レベルアップ版<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
            ...
            <section id="contents" class="program">
                <div class="box-contents">
                    <hgroup>
                        ...
                        <h2>農業簿記10<br>平成29年 年末レベルアップ版<br>(Ver.10.01.00)&nbsp;ダウンロード</h2><br>
                        <dl class="clearfix">
                            <dt><span><a href="#downloadbox" onfocus="this.blur()"><img src="/common/images/pkg_nbk10_w316.gif" alt="農業簿記"></a></span></dt>
                            <dd><span>「農業簿記10 平成29年 年末レベルアップ版(Ver.10.01.00)」のインストール方法、レベルアップ内容については [ マニュアル（PDF） ] をご覧ください。</span>
                            <span class="text-bold">マニュアルをご覧になるにはAdobe&nbsp;Reader&reg;が必要です。</span></dd>
                        </dl>
                    </hgroup><br>
                    <h3>レベルアップ項目（Ver.10.01.00 での対応）</h3>
                    <ul class="square">
                        <li><b>収入金額の内訳の、金額自動集計に対応 《 収入保険制度対応 》</b></li>
                        <li><b>減価償却費仕訳作成画面の機能強化</b></li>
                        <li><b>青色申告科目設定画面 / 収支内訳書設定画面に印刷機能を追加</b></li>
                    ...
                    <h3 id="downloadbox">農業簿記10&nbsp;平成29年 年末レベルアップ版<br>(Ver.10.01.00)&nbsp;ダウンロード</h3>
                    <p>形式：EXEファイル&nbsp;(440MB)&nbsp;<span class="text-bold">ADSL以上の回線を推奨</span></p>
                    <p class="btn-dl01"><a href="<?= $link ?>prg">ダウンロード</a></p>
                    <ul class="links">
                        <li><a href="<?= $link ?>manual" onfocus="this.blur()" target="_blank">PDFマニュアル&nbsp;(486KB)</a></li>
                    ...
                    <p style="color:#f30;"><b>【大切なお知らせ】<br />「農業簿記10 平成29年 年末レベルアップ版(Ver.10.01.00)」のインストール後、必ずこちらのサービスパックをダウンロードし、適用してください。</b></p>
                    <ul class="links">
                        <li><a href="../../softdown/nbk10_1001/index.php" onfocus="this.blur()" target="_blank">農業簿記10 平成29年 年末レベルアップ版(Ver.10.01.00)対応サービスパック</a></li>
                    </ul>
                </div>
            </section>
        </article>
        <footer>
            <div id="linkBox" class="clearfix">
                <ul>
                    <li><a href="/index.php">HOME</a>&nbsp;&gt;&nbsp;<a href="/program.php">プログラム更新</a>&nbsp;&gt;&nbsp;農業簿記10&nbsp;平成29年 年末レベルアップ版</li>
                </ul>
