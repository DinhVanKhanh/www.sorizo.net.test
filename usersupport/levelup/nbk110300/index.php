...
<div style="margin-left:1em; text-indent:-1em; margin-top:0.5em; font-size:90%;">* Ver.11.02.xxをお使いの場合 : SP1472112（2021年12月17日提供開始）以降のサービスパック<br>Ver.11.01.xxをお使いの場合 : SP1482112（2021年12月20日提供開始）以降のサービスパック</div>
                                        <br>
                                        すでに切り替えがお済みのオンラインソリマチクラブ会員様は、本プログラムをダウンロードする必要はございません。<br>
<!--
                                        &nbsp;→&nbsp;「ソリマチ安心データバンク」のご案内は<a href="#toku_info">こちら</a>
-->
                                    </span>
                                </div>
                            </dd>
                    ...
                    <ul class="square">
                        ...
                        <li><b>令和3年用申告用紙の様式変更に対応</b><br>
                            ・令和3年分申告用の青色申告決算書などの様式変更に対応しました。
                        </li>
                    ...
                    <p>形式：EXEファイル&nbsp;(490 MB)&nbsp;<span class="text-bold">ADSL以上の回線を推奨</span></p>
                    <form method="post" action="../files.php" target="_blank" name="levelup_download" class="btn-dl01">
                        <dl>
                            <input type="hidden" name="id" value="1" />
                            <input type="hidden" name="serial_no" value="<?=GetLoginSerial()?>" />
                            <input type="hidden" name="prod" value="<?=basename(__DIR__)?>" />
                            <a href="javascript:void(0)" onclick="document.levelup_download.submit();">ダウンロード</a>
                        </dl>
                    </form>
                    <ul class="links">
                    ...
                    <!--
                    <p style="color:#f30;"><b>【大切なお知らせ】<br />「農業簿記11 令和3年年末レベルアップ版(Ver.11.03.00)」のインストール後、必ずこちらのサービスパックをダウンロードし、適用してください。</b></p>
                    <ul class="links">
                        <li><a href="../../softdown/nbk11_1103/" onfocus="this.blur()" target="_blank">農業簿記11 令和3年年末レベルアップ版(Ver.11.03.00)対応サービスパック</a></li>
                    </ul>
                    -->
                </div>
            </section>
        ...
        <footer>
            <div id="linkBox" class="clearfix">
                <ul>
                    <li><a href="/">HOME</a>&nbsp;&gt;&nbsp;<a href="/program.php">プログラム更新</a>&nbsp;&gt;&nbsp;農業簿記11&nbsp;令和3年年末レベルアップ版</li>
                </ul>
