...
<meta name="description" content="特定商取引法に関する記述" />
<title>特定商取引法に関する記述｜そり蔵ネット</title>
...
<body id="logout">
    ...
    <article id="home" class="clearfix">
        <nav class="clearfix">
            <h1><a href="/index.php" onfocus="this.blur()">特定商取引法に関する記述
                <span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span>
            </a></h1>
        ...
        <section id="contents" class="service">
            <div class="box-contents">
                <hgroup>
                    <p><a href="/service.php">↑関連サービス</a></p>
                    <h2>特定商取引法に関する記述</h2>
                </hgroup><br>
                <p>｢特定商取引に関する法律｣第１１条（通信販売についての広告）に基づき以下に明示します。</p>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <th>所在地</td>
                        <td>〒141-0022<br>東京都品川区東五反田3-18-6 ソリマチ第８ビル</td>
                    </tr>
                    <tr>
                        <th>担当部署</td>
                        <td>営業統轄本部農業情報営業部</td>
                    ...
                    <tr>
                        <th>サービス（商品）価格</td>
                        <td>サービス毎、又は商品毎に記載※</td>
                    </tr>
                    <tr>
                        <th>サービス（商品）代金以外の必要料金</td>
                        <td>消費税</td>
                    </tr>
                    <tr>
                        <th>申込方法</td>
                        <td>サイト内各サービスページ※より</td>
                    </tr>
                    <tr>
                        <th>問合せ方法</td>
                        <td>商品毎のお問合せページより※</td>
                    ...
                    <tr>
                        <th>※各サービスページ（有料サービス）</td>
                        <td><a href="/supply/index.php">ソリマチ専用帳票のお申し込み（ＦＡＸ）</a></td>
                    </tr>
                </table>
            </div>
        </section>
    ...
    <footer>
        <div id="linkBox" class="clearfix">
            <ul>
                <li><a href="/">HOME</a>&nbsp;&gt;&nbsp;<a href="/service.php">関連サービス</a>&nbsp;&gt;&nbsp;特定商取引法に関する記述</li>
            </ul>
