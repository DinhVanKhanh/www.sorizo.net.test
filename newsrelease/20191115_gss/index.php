...
<title>新着情報&nbsp;[2019/11/15]｜そり蔵ネット</title>
...
<body id="logout">
	...
	<article id="home" class="clearfix">
		<nav class="clearfix">
            <h1><a href="/top.asp" onfocus="this.blur()">新着情報&nbsp;[2019/11/15]<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
		...
		<section id="contents" class="community">
			<div class="box-contents">
				<hgroup>
					...
					<h2><span class="text-red">農業簿記をお使いの皆様へ</span>源泉徴収票作成システム<br>令和元年版<span>ダウンロードサービス開始のお知らせ<br>対象製品：農業簿記11</span></h2>
				</hgroup><br>

				<p>平素は弊社ならびに弊社製品をご愛顧いただきまして、誠にありがとうございます。</p>
				<p>令和元年11月15日（金）より、『源泉徴収票作成システム 令和元年版』のダウンロードサービスを開始いたしました。<!--令和元度制度改正版の源泉徴収票に対応した最新版です。--></p>
                ...
                <?php if (CheckUserStatusByProduct("1015") == 1) { ?>
                    <p><b><a href="/usersupport/gensen/index.asp">→源泉徴収票作成システム　ダウンロード</a></b></p>
                <?php } else { ?>
                    <h4>本件に関するお問い合わせ先</h4>
                    <p>ソリマチ株式会社 東京本社<br>ＴＥＬ：03-5475-5301</p>
				    <h5>受付時間</h5> 
                    <p>9:00～17:30<br>※土・日・祝日および弊社指定休日を除く</p>
                <?php } ?>
	...
	<footer>
		<div id="linkBox" class="clearfix">
			<ul>
				<li><a href="/top.asp">HOME</a>&nbsp;&gt;&nbsp;<a href="/community.asp">そり蔵公民館</a>&nbsp;&gt;&nbsp;<a href="/newsrelease/list.asp">新着情報一覧</a>&nbsp;&gt;&nbsp;新着情報&nbsp;[2019/11/15]</li>
			</ul>
