...
<meta name="description" content="【サービス終了のお知らせ】旧製品による仕訳チェックサービス" />
<title>新着情報&nbsp;[2020/03/04]｜そり蔵ネット</title>
...
<body id="logout">
	...
	<article id="home" class="clearfix">
		<nav class="clearfix">
            <h1><a href="/top.asp" onfocus="this.blur()">新着情報&nbsp;[2020/03/04]<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
		...
		<section id="contents" class="community">
			<div class="box-contents">
				<hgroup>
					...
					<h2><span class="text-red">【サービス終了のお知らせ】</span>旧製品による仕訳チェックサービス
</span></h2>
				</hgroup><br>
				<p>

平素より農業簿記シリーズをご愛顧賜りまして誠にありがとうございます。<br>
農業簿記シリーズでは従来より仕訳チェックサービスを提供しておりますが、消費税率引上げや軽減税率制度の開始、その他の税制改正に伴い、こららに対応をしていない旧製品に入力された仕訳のチェックサービスの品質を維持することが困難となりました。このような状況から、旧製品による仕訳チェックサービスを終了させていただくことにいたしました。</p>
				<p><span style="color:#228b22;">■</span><b>サービス終了日</b>：2020年3月31日</p>
				<p><span style="color:#228b22;">■</span><b>終了対象サービス</b>：農業簿記10、農業簿記9、農業簿記8 による仕訳チェックサービス</p>
				<p>ご利用のお客様には大変ご迷惑をおかけいたしますが、何卒ご理解いただきますよう、よろしくお願い申し上げます。<br>なお、最新バージョンの農業簿記では引き続き仕訳チェックサービスをご利用いただくことができます。<br>ぜひ、この機会に最新製品への<a href="https://www.sorimachi.co.jp/lp-promo/boki.asp" target="_blank">お得なバージョンアップ</a>をご検討くださいませ。</p>
				<p>今後とも農業簿記シリーズをご愛顧賜りますよう、よろしくお願いいたします。</p>
			</div>
		</section>
	</article>
	<footer>
		<div id="linkBox" class="clearfix">
			<ul>
				<li><a href="/top.asp">HOME</a>&nbsp;&gt;&nbsp;<a href="/community.asp">そり蔵公民館</a>&nbsp;&gt;&nbsp;<a href="/newsrelease/list.asp">新着情報一覧</a>&nbsp;&gt;&nbsp;新着情報&nbsp;[2020/03/04]</li>
            </ul>
