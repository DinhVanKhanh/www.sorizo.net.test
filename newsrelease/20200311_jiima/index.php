...
<meta name="description" content="農業簿記が電子帳簿ソフト法的要件認証を取得いたしました" />
<title>新着情報&nbsp;[2020/03/11]｜そり蔵ネット</title>
...
<body id="logout">
	...
	<article id="home" class="clearfix">
		<nav class="clearfix">
			<h1><a href="/top.asp" onfocus="this.blur()">新着情報&nbsp;[2020/03/11]<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
		...
		<section id="contents" class="community">
			<div class="box-contents">
				<hgroup>
					...
					<h2><span class="text-red">【お知らせ】</span>農業簿記が電子帳簿ソフト法的要件認証を取得いたしました
</span></h2>
				</hgroup><br>
				<p>
平素は農業簿記11をご利用いただき、誠にありがとうございます。<br>
この度「農業簿記11」は、日本文書情報マネジメント協会（JIIMA) の「電子帳簿ソフト法的要件認証」を取得しました。</p>
				<p>2020年以降も65万円の青色申告特別控除を受けるには、電子申告をするか、または電子帳簿保存を行うことが条件となります。</p>
				<p>電子帳簿保存を行うには、「国税関係帳簿の電磁的記録等による保存等の承認申請書」と添付書類を提出し、税務署から承認を受ける必要があります(※)が、農業簿記11をお使いで2020年3月9日以降に税務署に電子帳簿保存申請をされる場合は、提出する申請書の記入が簡略化されます。</p>
				<p>※令和2年分に限っては、令和2年9月30日までに承認申請書を提出し、同年中に承認を受けて、同年12月31日までの間に、仕訳帳及び総勘定元帳の電磁的記録による備え付け及び保存を行うことで、65万円の青色申告特別控除を受けることができます。</p>
				<p><span style="color:#228b22;">■</span><b>対象製品：農業簿記11 [Version 11.01.00 以上]</b><br><span style="color:#228b22;">■</span><b>認証番号：100800-00</b></p>
				<p>制度や農業簿記11での設定方法の詳細は<a href="https://qa.sorimachi.co.jp/hc/ja/articles/360040707831" target="_blank"><b>こちらの製品Ｑ＆Ａ</b></a>をご確認ください。</p>
				<p>今後ともソリマチ株式ならびに農業簿記をよろしくお願い申し上げます。</p>
			</div>
		</section>
	</article>
	<footer>
		<div id="linkBox" class="clearfix">
			<ul>
				<li><a href="/top.asp">HOME</a>&nbsp;&gt;&nbsp;<a href="/community.asp">そり蔵公民館</a>&nbsp;&gt;&nbsp;<a href="/newsrelease/list.asp">新着情報一覧</a>&nbsp;&gt;&nbsp;新着情報&nbsp;[2020/03/11]</li>
			</ul>
