...
<meta name="keywords" content="簿記,日誌,ソリマチクラブ" />
<meta name="description" content="農業簿記9 平成27年みなし仕入れ率改正対応版ダウンロードサービス開始のお知らせ" />
<title>新着情報&nbsp;[2016/04/26]｜そり蔵ネット</title>
...
<body id="logout">
	...
	<article id="home" class="clearfix">
		<nav class="clearfix">
            <h1><a href="/top.asp" onfocus="this.blur()">新着情報&nbsp;[2016/04/26]<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
		...
		<section id="contents" class="community">
			<div class="box-contents">
				<hgroup>
					...
					<h2>九州地方で発生した地震で<br>被災されたお客様へ</h2>
				</hgroup><br>
				<p>このたびの九州地方における地震により被害を受けられた皆様に心よりお見舞い申し上げます。皆様の安全と、一刻も早い復旧をお祈り申し上げます。</p>
				<p>弊社では、本地震で被災されたお客様を対象として、下記の対応をさせていただきます。</p>
				<h4>■ソリマチクラブ会員の方</h4>
				<p>2016年4月末にソリマチクラブの期限が切れるお客様につきましては、会員期限を1カ月延長させていただきます。</p>
				<p>■<b>対象地域</b><br>災害救助法が適用されている地域のお客様が対象となります。内閣府の発表資料をご参照ください。<br>
<a href="http://www.bousai.go.jp/kohou/oshirase/pdf/20160415_01kisya.pdf" target="_blank"><b>→ 内閣府ホームページ：災害救助法の適用について【第1報】</b></a><br>
<span style="font-size:12px;">※上記は2016年4月15日現在の情報です。今後更新された場合は新しい情報に準じます。</span>
</p>
<br>
<p>上記以外の地域にお住まいの方々についても、天災でお困りのことがございましたら、全社を挙げて対応をさせていただきます。<br>個別での対応など何なりとお申し付け、ご相談くださいますようお願い申し上げます。</p>
			</div>
		</section>
	</article>
	<footer>
		<div id="linkBox" class="clearfix">
			<ul>
				<li><a href="/top.asp">HOME</a>&nbsp;&gt;&nbsp;<a href="/community.asp">そり蔵公民館</a>&nbsp;&gt;&nbsp;<a href="/newsrelease/list.asp">新着情報一覧</a>&nbsp;&gt;&nbsp;新着情報&nbsp;[2016/04/26]</li>
			</ul>
