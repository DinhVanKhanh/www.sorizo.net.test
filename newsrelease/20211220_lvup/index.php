...
<meta name="description" content="農業簿記11 令和3年年末レベルアップ版ダウンロードサービス開始のお知らせ" />
<title>新着情報&nbsp;[2021/12/20]｜そり蔵ネット</title>
...
<body id="logout">
	...
	<article id="home" class="clearfix">
		<nav class="clearfix">
            <h1><a href="/top.asp" onfocus="this.blur()">新着情報&nbsp;[2021/12/20]<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
		...
		<section id="contents" class="community">
			<div class="box-contents">
				<hgroup>
					...
					<h2><span class="text-red">重要なお知らせ</span>農業簿記11<br>令和3年年末レベルアップ版<span>ダウンロードサービス開始のお知らせ</span></h2>
				</hgroup><br>
				<p>平素は弊社ならびに弊社製品をご愛顧いただきまして、誠にありがとうございます。</p>
				<p>2021(令和3)年12月20日（月）より、「農業簿記11」をお使いのソリマチクラブ会員様向けに「令和3年年末レベルアップ版」のダウンロードサービスを開始いたします。</p>
				<p>ソリマチクラブ会員様には「農業簿記」のレベルアップ版をCD-ROMにてお送りしておりますが、ダウンロードサービスをご利用いただくことで、より早い時期にレベルアップ版をお使いいただくことができます。</p>
				<p>今後とも変わらぬご愛顧を賜りますよう、よろしくお願い申し上げます。</p>
				<h4>ご注意</h4>
				<ol>
					<li>本システムを使用するためには、「農業簿記11(Ver.11.00.00)」以上の製品がインストールされているパソコンが必要です。</li>
					<li>令和3年年末レベルアップ版はソリマチクラブ農業簿記会員様限定の提供プログラムです。</li>
					<li>所得税確定申告ソフトの最新版「みんなの確定申告〈令和3年分申告用〉」は、令和4年1月下旬の提供開始を予定しております。</li>

					<li>農業簿記11(Ver.11.01.00以降)をお使いのオンラインソリマチクラブ会員様は、最新のサービスパック(*)を適用し、農業簿記11を起動させると自動インストールで「農業簿記11 令和3年年末レベルアップ版」に切り替わります。<br>
<div style="margin-left:1em; text-indent:-1em; margin-top:0.3em; margin-bottom:0.3em; font-size:90%;">* Ver.11.02.xxをお使いの場合 : SP1472112（2021年12月17日提供開始）以降のサービスパック<br>Ver.11.01.xxをお使いの場合 : SP1482112（2021年12月20日提供開始）以降のサービスパック</div>すでに切り替えがお済みのオンラインソリマチクラブ会員様は、本プログラムをダウンロードする必要はございません。</li>
				</ol><br>
				<ul class="links">
				<?php if (CheckUserStatusByProduct("1015") == 1) { ?>
					<li style="list-style-type:none;"><a href="/usersupport/levelup/nbk110300/">「農業簿記11 令和3年年末レベルアップ版」のダウンロードはこちら</a></li>
				<?php } ?>
				</ul>
			</div>
		</section>
	...
	<footer>
		<div id="linkBox" class="clearfix">
			<ul>
				<li><a href="/top.asp">HOME</a>&nbsp;&gt;&nbsp;<a href="/community.asp">そり蔵公民館</a>&nbsp;&gt;&nbsp;<a href="/newsrelease/list.asp">新着情報一覧</a>&nbsp;&gt;&nbsp;新着情報&nbsp;[2021/12/20]</li>
            </ul>
