...
<meta name="description" content="農業簿記11 令和元年 年末レベルアップ版ダウンロードサービス開始のお知らせ" />
<title>新着情報&nbsp;[2019/12/23]｜そり蔵ネット</title>
...
<body id="logout">
	...
	<article id="home" class="clearfix">
		<nav class="clearfix">
            <h1><a href="/top.asp" onfocus="this.blur()">新着情報&nbsp;[2019/12/23]<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
		...
		<section id="contents" class="community">
			<div class="box-contents">
				<hgroup>
					...
					<h2><span class="text-red">重要なお知らせ</span>農業簿記11<br>令和元年 年末レベルアップ版<span>ダウンロードサービス開始のお知らせ</span></h2>
				</hgroup><br>
				<p>平素は弊社ならびに弊社製品をご愛顧いただきまして、誠にありがとうございます。</p>
				<p>2019(令和元)年12月23日（月）より、「農業簿記11」をお使いのソリマチクラブ会員様向けに「令和元年 年末レベルアップ版」のダウンロードサービスを開始いたします。</p>
				...
				<ol>
					...
					<li>令和元年 年末レベルアップ版はソリマチクラブ農業簿記会員様限定の提供プログラムです。</li>
					<li>所得税確定申告ソフトの最新版「みんなの確定申告〈令和元年分申告用〉」は、令和2年1月下旬の提供開始を予定しております。</li>
<!--
...
-->
				...
				<?php if (CheckUserStatusByProduct("1015") == 1) { ?>
					<li style="list-style-type:none;"><a href="/usersupport/levelup/nbk110100/">「農業簿記11 令和元年 年末レベルアップ版」のダウンロードはこちら</a></li>
				<?php } ?>
				</ul>
			</div>
		</section>
	...
	<footer>
		<div id="linkBox" class="clearfix">
			<ul>
				<li><a href="/top.asp">HOME</a>&nbsp;&gt;&nbsp;<a href="/community.asp">そり蔵公民館</a>&nbsp;&gt;&nbsp;<a href="/newsrelease/list.asp">新着情報一覧</a>&nbsp;&gt;&nbsp;新着情報&nbsp;[2019/12/23]</li>
            </ul>
