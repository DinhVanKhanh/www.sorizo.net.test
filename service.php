...
<body id="logout">
    ...
    <article id="list" class="clearfix">
        <nav class="clearfix">
            <h1><a href="/index.php" onfocus="this.blur()">関連サービス<span><img src="/common/images/box-icon-back-home.png" width="45" height="45" border="0"></span></a></h1>
            <?php require_once 'lib/nav_general.php'; ?>
        </nav>
        <section id="listMain" class="service">
            <div class="box-lm service">
                <h2><span>会員専用サービスが<br>ご利用いただけます</span></h2>
            </div>
        </section>
