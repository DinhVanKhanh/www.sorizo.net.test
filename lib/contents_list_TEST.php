...
//            }
                        ...
                        if (substr($IPCode, 0, 1) != "s") {
                            ...
                            if ($CodeExpires != "") {
                                ...
                                if (compareDate($Today, $CodeExpiresLimit) == 1) {
                                    ...
                                    if ($ContentsHandling != "") {
                                        if (($code == "online" || $code == "normal") && isShowOnline($IPCode, $code)) {
                                    ...
                                    if ($ContentsHandling == "ok" || $ContentsHandling == "online" || $ContentsHandling == "normal") {
    ...
    function isShowOnline($IPCode, $code) {
